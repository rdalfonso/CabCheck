...
- (NSMutableArray *)cabObjectInfos:(NSString*)searchTerm withString:(NSString*)cityObject {
	...
	if(openDatabaseResult == SQLITE_OK)
    {
      sqlite3_stmt *statement;
        ...
        NSString *query = [NSString stringWithFormat:@"SELECT id, driverType, driverName, driverMedallion, driverDMVLicense, driverVIN, driverCabMake, driverCabModel, driverCabYear, driverCompany, driverCompanyPhone FROM %@  WHERE driverMedallion like '%%%@%%' LIMIT 100", cityObject, searchClean];
